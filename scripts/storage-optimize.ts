    ...
    JSON.stringify(
      {
        ...
        nullUrlsRemoved: report.nullUrlsRemoved,
        referencesCompacted: report.referencesCompacted,
        chaptersRemoved: report.chaptersRemoved,
        gradesCompacted: report.gradesCompacted,
        directionalMarksStripped: report.directionalMarksStripped,
